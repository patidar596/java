...
<html>
<head>
<link href="<c:url value="/resources/styles/productform.css" />"
	rel="stylesheet">
<meta charset="UTF-8">
...
<body>
	<header>
		<div class="mylinks">
			<a href="<c:url value="/"/>">home</a> <a href="/log/user/cart">Mycart</a>
		</div>
	</header>
	...
	<div class="form_p" align="center">
		<div class="login">
			<form:form class="form" modelAttribute="product" action="getproduct"
				method="POST">
				<c:if test="${not empty error_message}">
					<p>${error_message}</p>
				</c:if>
				<c:if test="${not empty error_message2}">
					<p>${error_message2}</p>
				</c:if>
				<h1>Product</h1>
				<div class="group">
